...
const JoinUs = () => {
    return (
        <section className="joinUs" css={styles}>
            <div className="wrap">
                <div className="img1">
                    <JoinUsInfo title="FOR WOMEN" info="Special group sessions for women with women trainers 3 days a week." />
                </div>
            </div>
            <div className="wrap">
                <div className="img2">
                    <JoinUsInfo title="FOR GUYS" info="Morning and Evening workouts with pro trainers everyday of the week." />
                </div>
            </div>
