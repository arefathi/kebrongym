...
const Trainers = () => {
    return (
        <section className="trainers" css={styles}>
            ...
            <Container>
                <TrainerCard trainerImg={Trainer3} trainerName="Elsa Winters" trainerType="Woman Trainer" />
                <TrainerCard trainerImg={Trainer1} trainerName="Thomas Grey" trainerType="Men Trainer" />
                <TrainerCard trainerImg={Trainer2} trainerName="Paul Stew" trainerType="Men Trainer" />
            </Container>
        </section>
    )
}
